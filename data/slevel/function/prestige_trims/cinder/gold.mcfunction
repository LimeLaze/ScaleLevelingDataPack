item modify entity @s armor.head slevel:cinder/gold
item modify entity @s armor.chest slevel:cinder/gold
item modify entity @s armor.feet slevel:cinder/gold
item modify entity @s armor.legs slevel:cinder/gold
