item modify entity @s armor.head slevel:cinder/amethyst
item modify entity @s armor.chest slevel:cinder/amethyst
item modify entity @s armor.feet slevel:cinder/amethyst
item modify entity @s armor.legs slevel:cinder/amethyst
