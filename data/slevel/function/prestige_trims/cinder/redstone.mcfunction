item modify entity @s armor.head slevel:cinder/redstone
item modify entity @s armor.chest slevel:cinder/redstone
item modify entity @s armor.feet slevel:cinder/redstone
item modify entity @s armor.legs slevel:cinder/redstone
