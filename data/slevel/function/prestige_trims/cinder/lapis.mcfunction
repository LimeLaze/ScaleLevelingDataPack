item modify entity @s armor.head slevel:cinder/lapis
item modify entity @s armor.chest slevel:cinder/lapis
item modify entity @s armor.feet slevel:cinder/lapis
item modify entity @s armor.legs slevel:cinder/lapis
