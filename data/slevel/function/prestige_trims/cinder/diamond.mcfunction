item modify entity @s armor.head slevel:cinder/diamond
item modify entity @s armor.chest slevel:cinder/diamond
item modify entity @s armor.feet slevel:cinder/diamond
item modify entity @s armor.legs slevel:cinder/diamond
