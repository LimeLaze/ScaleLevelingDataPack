item modify entity @s armor.head slevel:cinder/iron
item modify entity @s armor.chest slevel:cinder/iron
item modify entity @s armor.feet slevel:cinder/iron
item modify entity @s armor.legs slevel:cinder/iron
