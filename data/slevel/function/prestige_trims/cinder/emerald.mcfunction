item modify entity @s armor.head slevel:cinder/emerald
item modify entity @s armor.chest slevel:cinder/emerald
item modify entity @s armor.feet slevel:cinder/emerald
item modify entity @s armor.legs slevel:cinder/emerald
