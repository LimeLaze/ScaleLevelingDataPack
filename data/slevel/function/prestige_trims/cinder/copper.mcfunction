item modify entity @s armor.head slevel:cinder/copper
item modify entity @s armor.chest slevel:cinder/copper
item modify entity @s armor.feet slevel:cinder/copper
item modify entity @s armor.legs slevel:cinder/copper
