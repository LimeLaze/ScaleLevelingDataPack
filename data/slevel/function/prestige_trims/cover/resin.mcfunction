item modify entity @s armor.head slevel:cover/resin
item modify entity @s armor.chest slevel:cover/resin
item modify entity @s armor.feet slevel:cover/resin
item modify entity @s armor.legs slevel:cover/resin
