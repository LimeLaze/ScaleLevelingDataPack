item modify entity @s armor.head slevel:cover/iron
item modify entity @s armor.chest slevel:cover/iron
item modify entity @s armor.feet slevel:cover/iron
item modify entity @s armor.legs slevel:cover/iron
