item modify entity @s armor.head slevel:cover/redstone
item modify entity @s armor.chest slevel:cover/redstone
item modify entity @s armor.feet slevel:cover/redstone
item modify entity @s armor.legs slevel:cover/redstone
