item modify entity @s armor.head slevel:cover/diamond
item modify entity @s armor.chest slevel:cover/diamond
item modify entity @s armor.feet slevel:cover/diamond
item modify entity @s armor.legs slevel:cover/diamond
