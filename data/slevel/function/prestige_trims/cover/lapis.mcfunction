item modify entity @s armor.head slevel:cover/lapis
item modify entity @s armor.chest slevel:cover/lapis
item modify entity @s armor.feet slevel:cover/lapis
item modify entity @s armor.legs slevel:cover/lapis
