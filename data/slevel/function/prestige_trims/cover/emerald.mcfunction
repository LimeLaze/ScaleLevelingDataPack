item modify entity @s armor.head slevel:cover/emerald
item modify entity @s armor.chest slevel:cover/emerald
item modify entity @s armor.feet slevel:cover/emerald
item modify entity @s armor.legs slevel:cover/emerald
