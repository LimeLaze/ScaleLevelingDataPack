item modify entity @s armor.head slevel:cover/netherite
item modify entity @s armor.chest slevel:cover/netherite
item modify entity @s armor.feet slevel:cover/netherite
item modify entity @s armor.legs slevel:cover/netherite
