item modify entity @s armor.head slevel:cover/quartz
item modify entity @s armor.chest slevel:cover/quartz
item modify entity @s armor.feet slevel:cover/quartz
item modify entity @s armor.legs slevel:cover/quartz
