item modify entity @s armor.head slevel:nameless/lapis
item modify entity @s armor.chest slevel:nameless/lapis

item modify entity @s armor.legs slevel:nameless/lapis
