item modify entity @s armor.head slevel:nameless/resin
item modify entity @s armor.chest slevel:nameless/resin

item modify entity @s armor.legs slevel:nameless/resin
