item modify entity @s armor.head slevel:nameless/gold
item modify entity @s armor.chest slevel:nameless/gold

item modify entity @s armor.legs slevel:nameless/gold
