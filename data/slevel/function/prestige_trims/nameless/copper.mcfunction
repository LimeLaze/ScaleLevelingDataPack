item modify entity @s armor.head slevel:nameless/copper
item modify entity @s armor.chest slevel:nameless/copper

item modify entity @s armor.legs slevel:nameless/copper
