item modify entity @s armor.head slevel:nameless/diamond
item modify entity @s armor.chest slevel:nameless/diamond

item modify entity @s armor.legs slevel:nameless/diamond
