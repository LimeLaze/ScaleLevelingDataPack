item modify entity @s armor.head slevel:nameless/netherite
item modify entity @s armor.chest slevel:nameless/netherite

item modify entity @s armor.legs slevel:nameless/netherite
