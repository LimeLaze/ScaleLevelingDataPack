item modify entity @s armor.head slevel:nameless/redstone
item modify entity @s armor.chest slevel:nameless/redstone

item modify entity @s armor.legs slevel:nameless/redstone
