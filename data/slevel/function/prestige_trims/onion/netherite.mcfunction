item modify entity @s armor.head slevel:onion/netherite
item modify entity @s armor.chest slevel:onion/netherite
item modify entity @s armor.feet slevel:onion/netherite
item modify entity @s armor.legs slevel:onion/netherite
