item modify entity @s armor.head slevel:onion/copper
item modify entity @s armor.chest slevel:onion/copper
item modify entity @s armor.feet slevel:onion/copper
item modify entity @s armor.legs slevel:onion/copper
