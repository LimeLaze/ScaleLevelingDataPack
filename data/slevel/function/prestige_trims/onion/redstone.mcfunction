item modify entity @s armor.head slevel:onion/redstone
item modify entity @s armor.chest slevel:onion/redstone
item modify entity @s armor.feet slevel:onion/redstone
item modify entity @s armor.legs slevel:onion/redstone
