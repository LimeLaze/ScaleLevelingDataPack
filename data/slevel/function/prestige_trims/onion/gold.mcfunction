item modify entity @s armor.head slevel:onion/gold
item modify entity @s armor.chest slevel:onion/gold
item modify entity @s armor.feet slevel:onion/gold
item modify entity @s armor.legs slevel:onion/gold
