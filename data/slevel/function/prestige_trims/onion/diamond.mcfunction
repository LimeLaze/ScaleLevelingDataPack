item modify entity @s armor.head slevel:onion/diamond
item modify entity @s armor.chest slevel:onion/diamond
item modify entity @s armor.feet slevel:onion/diamond
item modify entity @s armor.legs slevel:onion/diamond
