item modify entity @s armor.head slevel:onion/quartz
item modify entity @s armor.chest slevel:onion/quartz
item modify entity @s armor.feet slevel:onion/quartz
item modify entity @s armor.legs slevel:onion/quartz
