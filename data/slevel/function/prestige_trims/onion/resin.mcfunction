item modify entity @s armor.head slevel:onion/resin
item modify entity @s armor.chest slevel:onion/resin
item modify entity @s armor.feet slevel:onion/resin
item modify entity @s armor.legs slevel:onion/resin
