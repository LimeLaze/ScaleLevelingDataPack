item modify entity @s armor.head slevel:shovel/diamond
item modify entity @s armor.chest slevel:shovel/diamond
item modify entity @s armor.feet slevel:shovel/diamond
item modify entity @s armor.legs slevel:shovel/diamond
