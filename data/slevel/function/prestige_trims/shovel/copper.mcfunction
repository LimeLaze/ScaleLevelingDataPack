item modify entity @s armor.head slevel:shovel/copper
item modify entity @s armor.chest slevel:shovel/copper
item modify entity @s armor.feet slevel:shovel/copper
item modify entity @s armor.legs slevel:shovel/copper
