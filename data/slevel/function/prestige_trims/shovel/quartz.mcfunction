item modify entity @s armor.head slevel:shovel/quartz
item modify entity @s armor.chest slevel:shovel/quartz
item modify entity @s armor.feet slevel:shovel/quartz
item modify entity @s armor.legs slevel:shovel/quartz
