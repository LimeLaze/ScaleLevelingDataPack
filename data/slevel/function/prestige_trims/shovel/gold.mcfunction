item modify entity @s armor.head slevel:shovel/gold
item modify entity @s armor.chest slevel:shovel/gold
item modify entity @s armor.feet slevel:shovel/gold
item modify entity @s armor.legs slevel:shovel/gold
