item modify entity @s armor.head slevel:shovel/emerald
item modify entity @s armor.chest slevel:shovel/emerald
item modify entity @s armor.feet slevel:shovel/emerald
item modify entity @s armor.legs slevel:shovel/emerald
