item modify entity @s armor.head slevel:shovel/iron
item modify entity @s armor.chest slevel:shovel/iron
item modify entity @s armor.feet slevel:shovel/iron
item modify entity @s armor.legs slevel:shovel/iron
